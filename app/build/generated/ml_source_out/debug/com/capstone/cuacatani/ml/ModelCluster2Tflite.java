...
public final class ModelCluster2Tflite {
  @NonNull
  private final Model model;

  private ModelCluster2Tflite(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "model_cluster2_tflite.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static ModelCluster2Tflite newInstance(@NonNull Context context) throws IOException {
    return new ModelCluster2Tflite(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static ModelCluster2Tflite newInstance(@NonNull Context context,
      @NonNull Model.Options options) throws IOException {
    return new ModelCluster2Tflite(context, options);
  }

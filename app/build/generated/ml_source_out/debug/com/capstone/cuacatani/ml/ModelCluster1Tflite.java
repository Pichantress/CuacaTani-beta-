package com.capstone.cuacatani.ml;
...
public final class ModelCluster1Tflite {
  @NonNull
  private final Model model;

  private ModelCluster1Tflite(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "model_cluster1_tflite.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static ModelCluster1Tflite newInstance(@NonNull Context context) throws IOException {
    return new ModelCluster1Tflite(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static ModelCluster1Tflite newInstance(@NonNull Context context,
      @NonNull Model.Options options) throws IOException {
    return new ModelCluster1Tflite(context, options);
  }

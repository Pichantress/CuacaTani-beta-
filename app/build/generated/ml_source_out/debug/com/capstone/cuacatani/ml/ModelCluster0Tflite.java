...
public final class ModelCluster0Tflite {
  @NonNull
  private final Model model;

  private ModelCluster0Tflite(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "model_cluster0_tflite.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static ModelCluster0Tflite newInstance(@NonNull Context context) throws IOException {
    return new ModelCluster0Tflite(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static ModelCluster0Tflite newInstance(@NonNull Context context,
      @NonNull Model.Options options) throws IOException {
    return new ModelCluster0Tflite(context, options);
  }
